...
import { usePostProduct } from '../hook/product/mutate'
...
export default function CreateProductForm() {
  ...
  const DEFAULT_IMAGE = {
    url: 'https://res.cloudinary.com/dfxcqvjch/image/upload/v1789029425/images.png',
    publicId: 'images'
  }
  ...
  const [option, setOption] = React.useState<{title:string; value:string[]}[]>([]);
  ...
  const handleSubmit = async(e: React.FormEvent<Element>) => {
    ...
    postProduct.mutate({
      ...
      image: previewImage as File ?? DEFAULT_IMAGE,
      option
    }, {
      onSuccess: () => {
        router.push('/product')
